    ...
    return (
        <main className="order">
            ...
            <section className="order-success">
                ...
                <p>
                    Your order has been received successfully at GLAM LUXE. We're thrilled that you've chosen us for your HOUSEHOLD SOLUTIONS. Your style journey is about to begin!
                </p>
                <h3> Order Details:</h3>
                ...
                If you have any questions or need assistance, feel free to contact our customer support team at support@sglamluxe.com or +254 725 476 023.
                <br />
                <p>  Happy Shopping!
                </p>
                <p>Warm regards, <br />
                    The glam luxe Team</p>
            </section>
